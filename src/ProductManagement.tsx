...
export default function ProductManagement({ onHomeClick, onDashboardClick, onAiMarketingClick, onAiKnowledgeClick, onCrmClick, onAiManagerClick, onAiRecruitmentClick }: ProductManagementProps) {
