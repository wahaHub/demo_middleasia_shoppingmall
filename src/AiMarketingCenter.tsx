...
export default function AiMarketingCenter({ onHomeClick, onDashboardClick, onAiKnowledgeClick, onProductManagementClick, onCrmClick, onAiManagerClick, onAiRecruitmentClick, onBusinessCustomizationClick }: AiMarketingCenterProps) {
