...
export default function BusinessDashboard({ onHomeClick, onAiMarketingClick, onAiKnowledgeClick, onProductManagementClick, onCrmClick, onAiManagerClick, onAiRecruitmentClick, onBusinessCustomizationClick }: BusinessDashboardProps) {
  return (
