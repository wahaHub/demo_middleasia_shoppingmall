...
export default function AiKnowledgeBase({ onHomeClick, onDashboardClick, onAiMarketingClick, onProductManagementClick, onCrmClick, onAiManagerClick, onAiRecruitmentClick, onBusinessCustomizationClick }: AiKnowledgeBaseProps) {
